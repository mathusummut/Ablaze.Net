...
namespace System.Graphics.Models {
	...
	public interface IModel : ICloneable, IDisposable {
		...
		/// <summary>
		/// Gets or sets the default texture of the components when none is specified
		/// </summary>
		...
		/// <summary>
		/// Gets the number of components in the model (or frame count if AnimatedModel, or if it is a MeshComponent returns 1 if not empty else 0)
		/// </summary>
		int Count {
			get;
		}
