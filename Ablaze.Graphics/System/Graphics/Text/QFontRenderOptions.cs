...
namespace System.Graphics.Text {
	public enum QFontAlignment {
		Left = 0, Right, Centre, Justify
	}
	public enum QFontMonospacing {
		Natural = 0, Yes, No
	}

	public class QFontRenderOptions : ICloneable {
		/// <summary>
		/// The font colour
		/// </summary>
		...
		/// 
		/// </summary>
		public RectangleF? TransformToViewport = null;
		...
		public float JustifyCharacterWeightForExpand {
			get {
				return justifyCharWeightForExpand;
			}
			set {

				justifyCharWeightForExpand = Maths.Clamp(value, 0.0f, 1.0f);
		...
		public float JustifyCharacterWeightForContract {
			get {
				return justifyCharWeightForContract;
			}
			set {
