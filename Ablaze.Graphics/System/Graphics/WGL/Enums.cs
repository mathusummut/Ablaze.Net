...
namespace System.Graphics.WGL {
	...
	public enum Fx3dMultiSample {
		SampleBuffers3dfx = ((int) 0x2060),
		Samples3dfx = ((int) 0x2061),
	}

	public enum ArbRenderTexture {
	...
	public enum ArbPixelFormatFloat {
	...
	public struct LayerPlaneDescriptor {
		public static readonly Int16 Size = (Int16) Marshal.SizeOf(typeof(LayerPlaneDescriptor));
