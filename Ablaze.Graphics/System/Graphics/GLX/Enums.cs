...
namespace System.Graphics.GLX {
	public enum PixelFormatAttribute : int {
		EMPTY = 0,
	...
	public enum HyperpipeAttrib : int {
	...
	public enum RenderTypeMask : int {
	...
	public enum DrawableTypeMask : int {
	...
	public enum ErrorCode : int {
		...
		BAD_ATTRIBUTE = 2,
		/// <summary>
		/// No Glx extension present on server.
		/// </summary>
		NO_EXTENSION = 3,
		/// <summary>
		...
		BAD_ENUM = 7,
		/// <summary>
		/// Invalid hyper-pipe configuration.
		/// </summary>
