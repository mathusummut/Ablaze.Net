...
namespace System.Drawing {
	...
	public struct Vector3 : IEquatable<Vector3> {
		...
		public float LengthFast {
			get {
				return 1f / MathHelper.InverseSqrtFast(X * X + Y * Y + Z * Z);
			}
		}
		...
		public static void Transform(ref Vector3 vec, ref Matrix4 mat, out Vector3 result) {
			Vector4 v4 = new Vector4(vec.X, vec.Y, vec.Z, 1f);
		...
		public static Vector3 Transform(Vector3 vec, Vector4 quat) {
			Vector3 result;
		...
		public static void Transform(ref Vector3 vec, ref Vector4 quat, out Vector3 result) {
		...
		/// <summary>
		/// Gets or sets an System.Vector2 with the X and Y components of this instance.
		/// </summary>
		public Vector2 Xy {
			get {
