...
namespace System.Drawing {
	...
	public struct Matrix4D : IEquatable<Matrix4D> {
		...
		public Vector4D Column0 {
			get {
				return new Vector4D(Row0.X, Row1.X, Row2.X, Row3.X);
			}
		}
		...
		public Vector4D Column1 {
			get {
				return new Vector4D(Row0.Y, Row1.Y, Row2.Y, Row3.Y);
			}
		}
		...
		public Vector4D Column2 {
			get {
				return new Vector4D(Row0.Z, Row1.Z, Row2.Z, Row3.Z);
			}
		}
		...
		/// <returns>A rotation matrix</returns>
		public static Matrix4D Rotate(Vector4D q) {
			Vector3D axis;
			double angle;
		...
		public static Matrix4D Invert(Matrix4D mat) {
			...
			inverse[0] = new double[] { mat.Row0.X, mat.Row0.Y, mat.Row0.Z, mat.Row0.W };
			inverse[1] = new double[] { mat.Row1.X, mat.Row1.Y, mat.Row1.Z, mat.Row1.W };
			inverse[2] = new double[] { mat.Row2.X, mat.Row2.Y, mat.Row2.Z, mat.Row2.W };
			inverse[3] = new double[] { mat.Row3.X, mat.Row3.Y, mat.Row3.Z, mat.Row3.W };
			int icol = 0;
			int irow = 0;
			for (int i = 0; i < 4; i++) {
