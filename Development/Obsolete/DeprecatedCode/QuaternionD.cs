...
namespace System.Drawing {
	...
	public struct QuaternionD : IEquatable<QuaternionD> {
		...
		/// Represents 0 in 4D
		/// </summary>
		public static readonly QuaternionD Zero = new QuaternionD(0D, 0D, 0D, 0D);
		...
		public Vector4D ToAxisAngle() {
			...
			result.W = 2f * (float) System.Math.Acos(q.W); // angle
		...
		public static QuaternionD Slerp(QuaternionD q1, QuaternionD q2, double blend) {
			...
			if (cosHalfAngle < 0.99f) {
				...
				double oneOverSinHalfAngle = 1f / sinHalfAngle;
				blendA = (double) System.Math.Sin(halfAngle * (1f - blend)) * oneOverSinHalfAngle;
