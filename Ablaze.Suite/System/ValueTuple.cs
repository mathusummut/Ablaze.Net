...
namespace System {
	...
	public struct ValueTuple
		...
		int IComparable.CompareTo(object other) {
			...
			if (!(other is ValueTuple)) {
				throw new ArgumentException("ArgumentException_ValueTupleIncorrectType", nameof(other));
			}
		...
		internal static int CombineHashCodes(int h1, int h2) {
			return Extensions.Combine(h1, h2);
		}

		internal static int CombineHashCodes(int h1, int h2, int h3) {
			return Extensions.Combine(CombineHashCodes(h1, h2), h3);
		}

		internal static int CombineHashCodes(int h1, int h2, int h3, int h4) {
			return Extensions.Combine(CombineHashCodes(h1, h2, h3), h4);
		}

		internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5) {
			return Extensions.Combine(CombineHashCodes(h1, h2, h3, h4), h5);
		}

		internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5, int h6) {
			return Extensions.Combine(CombineHashCodes(h1, h2, h3, h4, h5), h6);
		}

		internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5, int h6, int h7) {
			return Extensions.Combine(CombineHashCodes(h1, h2, h3, h4, h5, h6), h7);
		}

		internal static int CombineHashCodes(int h1, int h2, int h3, int h4, int h5, int h6, int h7, int h8) {
			return Extensions.Combine(CombineHashCodes(h1, h2, h3, h4, h5, h6, h7), h8);
		}
	}
	...
	public struct ValueTuple<T1, T2, T3, T4>
		...
		/// </remarks>
		public override string ToString() {
			return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ")";
		}
	...
	public struct ValueTuple<T1, T2, T3, T4, T5>
		...
		/// </remarks>
		public override string ToString() {
			return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ")";
		}
	...
	public struct ValueTuple<T1, T2, T3, T4, T5, T6>
		...
		/// </remarks>
		public override string ToString() {
			return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString()) + ")";
		}
	...
	public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7>
		...
		/// </remarks>
		public override string ToString() {
			return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString()) + ", " + (Item7 == null ? null : Item7.ToString()) + ")";
		}
	...
	public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>
		...
		public ValueTuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, TRest rest) {
			if (!(rest is ITupleInternal)) {
				throw new ArgumentException("ArgumentException_ValueTupleLastArgumentNotAValueTuple");
			}
		...
		public override string ToString() {
			ITupleInternal rest = Rest as ITupleInternal;
			if (rest == null) {
				return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString()) + ", " + (Item7 == null ? null : Item7.ToString()) + ", " + Rest + ")";
			} else {
				return "(" + (Item1 == null ? null : Item1.ToString()) + ", " + (Item2 == null ? null : Item2.ToString()) + ", " + (Item3 == null ? null : Item3.ToString()) + ", " + (Item4 == null ? null : Item4.ToString()) + ", " + (Item5 == null ? null : Item5.ToString()) + ", " + (Item6 == null ? null : Item6.ToString()) + ", " + (Item7 == null ? null : Item7.ToString()) + ", " + rest.ToStringEnd();
			}
		}
