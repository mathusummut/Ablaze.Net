...
namespace AForge.Video {
	...
	public class AsyncVideoSource : IVideoSource {
		...
		public string Source {
			get {
				return nestedVideoSource.Source;
			}
		}
		...
		public int FramesReceived {
			get {
				return nestedVideoSource.FramesReceived;
			}
		}
		...
		public long BytesReceived {
			get {
				return nestedVideoSource.BytesReceived;
			}
		}
		...
		private static Bitmap CloneImage(BitmapData sourceData) {
			...
			unsafe
			{
				ByteArrayUtils.MemoryCopy((byte*) destinationData.Scan0, (byte*) sourceData.Scan0, (uint) (height * sourceData.Stride));
			}
